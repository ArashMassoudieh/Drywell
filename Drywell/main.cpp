 ...
 // alpha=30, n=2, dg=0.5, rw=0
    ...
    */
    ...
    for (QMap<QString, ModelParameters>::iterator it = parameter_set.begin(); it!= parameter_set.end(); it++)
    {
        ...
        string Basefolder = "/home/khiem/Projects/Drywell_Result/Homogeneous/";
        string Results_Folder = Basefolder + it->folder.toStdString();
        //string Results_Folder = "F:/Projects/Drywell_Result";
        QDir dir(QString::fromStdString(Basefolder));
