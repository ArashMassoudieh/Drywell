...
int main()
{
    ...
    P.write("K_sat_normal_score","/home/khiem/Projects/Drywell_Result/Heterogeneous/Test/K_sat_score_1.txt");
    P.Normalize_Ksat_normal_scores(1,0.1);
    P.write("K_sat_normal_score","/home/khiem/Projects/Drywell_Result/Heterogeneous/Test/K_sat_score_2.txt");

    CTimeSeries<double> K_sat_marginal_CDF("/home/khiem/Projects/Drywell_Result/Heterogeneous/K_sat_Marginal_Distribution.csv"); // Loading Cummulative Distributions
    CTimeSeries<double> alpha_marginal_CDF("/home/khiem/Projects/Drywell_Result/Heterogeneous/alpha_Marginal_Distribution.csv");
    CTimeSeries<double> n_marginal_CDF("/home/khiem/Projects/Drywell_Result/Heterogeneous/n_Marginal_Distribution.csv");
    ...
    P.write("K_sat","/home/khiem/Projects/Drywell_Result/Heterogeneous/Test/K_sat.txt");
    P.write("alpha","/home/khiem/Projects/Drywell_Result/Heterogeneous/Test/alpha.txt");
    P.write("n","/home/khiem/Projects/Drywell_Result/Heterogeneous/Test/n.txt");
    ...
    G.ExtractMoisture(1,0).writefile("/home/khiem/Projects/Drywell_Result/Heterogeneous/Test/moist_well.csv");
    ...
    G.WriteResults("/home/khiem/Projects/Drywell_Result/Heterogeneous/Test/theta.vtp");
    G.WaterDepth().make_uniform(0.1).writefile("/home/khiem/Projects/Drywell_Result/Heterogeneous/Test/waterdepth.csv");
    cout<<"done!"<<endl;
}
