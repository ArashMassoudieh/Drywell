...
int main()
{
    ...
    G.ExtractMoisture(3,2).writefile("/home/arash/Projects/Drywell_Results/Test/moist_10_5.csv");
    G.ExtractMoisture(2,3).writefile("/home/arash/Projects/Drywell_Results/Test/moist_10_5.csv");
